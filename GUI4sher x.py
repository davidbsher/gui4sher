...
def get_save():
  ...
  while len(save_file)==0:
    ...
    while True:
        ...
        print('file:',save_file.lower(),str(save_file.lower().startswith('gui4sher')))
        if not save_file.lower().startswith('gui4sher'): break  # can't overwrite the gui4sher project creator
