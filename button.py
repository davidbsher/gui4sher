...
save_file = __file__
# not saved
clicks_window.insert('end',"\ndef orange_button_click():\n\tcolored_rectangle.set_fill('orange')\n\ncount = 0 # counts how many times the counter button was clicked\n\ndef counter_button_click():\n\t''' controls what happens when you click the counter button '''\n\tglobal count\t\t# lets you change the count variable\n\tcount += 1\t\t# counts another click\n\tcounter_button.set_text(str(count)+' Clicks')\t# puts the click count on button\n\n\n")

''' All the objects in the graphics are below '''

colored_rectangle = Rectangle(Point(37.0,21.0),Point(173.0,210.0))
colored_rectangle.set_name('colored_rectangle')
colored_rectangle.set_fill('orange')
colored_rectangle.set_outline('black')
colored_rectangle.set_width('1')
colored_rectangle.draw()
orange_button = Button(Point(225.0,43.0),"orange","orange_button")
orange_button.set_fill('cyan')
orange_button.set_outline('black')
orange_button.set_width('6')
orange_button.set_text('orange')
orange_button.set_font(('times', 14))
orange_button.set_justify('center')
orange_button.draw()
counter_button = Button(Point(381.0,73.0),"2 Clicks","counter_button")
counter_button.set_fill('cyan')
counter_button.set_outline('black')
counter_button.set_width('8')
counter_button.set_text('2 Clicks')
counter_button.set_font(('times', 14))
counter_button.set_justify('center')
counter_button.draw()
# not saved
try:
	exec(clicks_window.get('1.0','end'))
