...
save_file = __file__
# not saved
clicks_file = 'C:/Users/david/OneDrive/GitHub/gui4sher/test_clicks.py'
# not saved
change_title('Project in C:\Users\david\OneDrive\GitHub\gui4sher\test.py put button click functions in C:/Users/david/OneDrive/GitHub/gui4sher/test_clicks.py')
''' All the objects in the graphics are below '''
rect = Rectangle(Point(87.0,71.0),Point(87.0,71.0))
rect.set_name('rect')
rect.set_fill('')
rect.set_outline('black')
rect.set_width('1')
rect.draw()
nack = Rectangle(Point(143.0,135.0),Point(232.0,194.0))
nack.set_name('nack')
nack.set_fill('')
nack.set_outline('black')
nack.set_width('1')
nack.draw()
# not saved
root.mainloop()
