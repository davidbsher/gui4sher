...
save_file = __file__
# not saved
change_title('Project in C:\Users\david\OneDrive\GitHub\gui4sher\test.py')

''' All the objects in the graphics are below '''

clicker = Button(Point(60.0,46.0),"Click")
clicker.set_name('clicker')
clicker.set_fill('cyan')
clicker.set_outline('black')
clicker.set_width('5')
clicker.set_text('Click')
clicker.set_font(('script', 30))
